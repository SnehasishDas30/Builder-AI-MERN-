        ...
        return (
            <div>
                <div
                    ...
                    className="flex items-center gap-2 py-1 px-2 text-xs text-zinc-400 hover:text-zinc-200 cursor-pointer select-none"
                    style={{ paddingLeft: `${depth * 12 + 8}px` }}
                >
                    <FolderOpenIcon size={14} className='text-zinc-500 opacity-60' />
                    <span>{node.name}</span>
                </div>
